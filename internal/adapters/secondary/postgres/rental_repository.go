...
func NewRentalRepository(db *pgxpool.Pool) output.RentalRepository {
...
func (r *RentalRepository) FindByID(ctx context.Context, id uuid.UUID) (*domain.Rental, error) {
...
func (r *RentalRepository) FindByUser(ctx context.Context, userID uuid.UUID) ([]*domain.Rental, error) {
	query := `
		SELECT ` + rentalCols + `
		FROM rentals
...
func (r *RentalRepository) scanRental(row pgx.Row) (*domain.Rental, error) {
	rental := &domain.Rental{}
...
func (r *RentalRepository) scanRow(rows pgx.Rows, rental *domain.Rental) error {
...
func (r *RentalRepository) scan(scanFn func(...any) error, rental *domain.Rental) error {
	var (
